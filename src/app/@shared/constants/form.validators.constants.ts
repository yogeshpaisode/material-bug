export const validatorsConfig = {
  ...
  decimalNumber: {
    msg: `Must contains only whole numbers or decimal numbers`,
    regEx: '^[+-]?([0-9]*[.])?[0-9]+',
  },
  password: {
    msg: `Must contain 8 characters having at-least 1 uppercase,1 lowercase,1 number and 1 special character`,
